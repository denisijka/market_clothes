(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".menu-icon")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".menu-icon")) {
                    bodyLockToggle();
                ...
                function showMoreActions(e) {
                    ...
                    if ("click" === targetType) {
                        if (targetEvent.closest("[data-showmore-button]")) {
                            ...
                            const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
                            const btnMore = document.querySelector(".show-more__button_less");
                            if (!showMoreContent.classList.contains("_slide")) {
                                showMoreBlock.classList.contains("_showmore-active") ? _slideUp(showMoreContent, showMoreSpeed, hiddenHeight) : _slideDown(showMoreContent, showMoreSpeed, hiddenHeight);
                                showMoreBlock.classList.toggle("_showmore-active");
                                btnMore.classList.toggle("_active");
                            }
                        }
        ...
        let sliders_innerWidth = window.innerWidth;
        window.addEventListener("resize", (() => {
            sliders_innerWidth = window.innerWidth;
        }));
        if (sliders_innerWidth <= 767.98) {
            console.log(sliders_innerWidth);
            ...
            if (document.querySelector(".slider-catalog__items_slider ")) new core(".slider-catalog__items_slider ", {
                observer: true,
                observeParents: true,
                slidesPerView: 1.4,
                spaceBetween: 32,
...
***************************************************************************** */
        ...
        window.onload = function() {
            ...
            if (myMap) {
                ...
                var singleMarker = L.marker([ 46.469794, 30.732835 ], {
                    icon: myIcon
                });
            ...
            window.addEventListener("click", (function(event) {
                ...
                if ("remove" === event.target.dataset.action) if (event.target.closest(".card-buy__wrapper")) event.target.closest(".product-info").remove();
            }));
